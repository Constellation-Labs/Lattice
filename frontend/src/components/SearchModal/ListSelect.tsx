...
const PopoverContainer = styled.div<{ show: boolean }>`
  ...
  background: ${({ theme }) => darken(0.1, theme.baseBg)};
  border: 1px solid ${({ theme }) => theme.baseBg};
  ...
  return (
    <Column style={{ width: '100%', flex: '1 1' }}>
      ...
      <PaddedColumn gap="14px">
        ...
        {addError ? (
          <TYPE.error fontSize={14} title={addError} style={{ textOverflow: 'ellipsis', overflow: 'hidden' }} error>
            {addError}
          </TYPE.error>
        ) : null}
      </PaddedColumn>
      ...
      <div style={{ padding: '16px', textAlign: 'center', fontSize: '14px' }}>
